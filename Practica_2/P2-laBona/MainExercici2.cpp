...
MainExercici2::MainExercici2(){
}

MainExercici2::~MainExercici2(){

}
void MainExercici2::inici(){
...
void MainExercici2::compare(int valor, int limitA, int limitB){
    if (valor < limitA || valor > limitB)
        throw invalid_argument( "Dades introduïdes incorrectes" );
}
bool MainExercici2::esNumero(char *lectura) {
    for( ; *lectura; ++lectura )
        if( !isdigit(*lectura) )
            return false;
    return true;
...
int MainExercici2::llegirStringTOint(string text, int limitA, int limitB) {
...
Posicio<Element> MainExercici2::inserirEnUnaPosicio(int pos, const Llista<Element> *pLlista) {
    int contador = 0;
    bool trobat = false;
...
void MainExercici2::llegirParaula(string &paraula){
    cout << "\nIntrodueix una paraula: ";
    cin >> paraula;
}
bool MainExercici2::inserirDades( string text){
    string opcio, op;
...
int MainExercici2::llegirPos(int tamany){
    int pos;
    try{
...
void MainExercici2::print(Llista<string> *l1) {
    try {
        cout << ".............." << endl;
...
void MainExercici2::printReverse(Llista<string> *l1 ) {
    try{
        cout << ".............." << endl;
...
void MainExercici2::primerNode(Llista<string> *l1, int &nParaules){
    string paraula;
    llegirParaula(paraula);
    l1->inserirPrincipi( paraula);
