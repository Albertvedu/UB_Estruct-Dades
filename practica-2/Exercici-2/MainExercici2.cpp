...
NodeLlista<Element> * inserirEnUnaPosicio(const int &pos, Llista<Element> *pLlista) {
    int contador = 0;
...
void primerNode(Llista<string> *l1, int &nParaules){
    ...
    cout << "\e[1mLa llista era buida. Paraula inserida en l'ùnic espai disponible.\e[0m\n" << endl;
    nParaules --;
}
int main(){
